    ...
    public class ChatView : MonoBehaviour
    {
        ...
        private void FirstMessage()
        {
            ...
            if (!isHistoryLoaded)
            {
                ...
                {
                    _welcomeMessage = "Привет! Чем могу быть полезен?";
                }
                else
                {
        ...
        public async void SendUserMessage()
        {
            ...
            {
                string buyMessage = "Похоже, у вас закончились монеты. Монеты нужны для отправки сообщений, их можно получить, приглашая друзей, просматривая рекламу или покупая их.";
